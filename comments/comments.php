...
class Comments
{
    ...
    { 
        ...
        $h->includeJs('comments', 'ajaxcomments');
    ...
    {        
        ...
        echo "<h4>" . $h->countComments(false, $h->lang['comments_leave_comment']) . "</h4>\n";
