...
function toggleMainCommentReply(){
    
     var attr = $(".mainform").attr('show');
               if(attr==1){
               $('.mainform').hide();
               $('.mainform').attr('show', 0);
                   
               } else if(attr==0){
                     $('.mainform').show();
               $('.mainform').attr('show', 1);
                   
               }
    
    
}
function toggleMainCommentEdit(){
